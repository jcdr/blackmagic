...
#define REMOTE_SWCLK_SET    'W'
#define REMOTE_SWCLK_GET    'w'
...
#define REMOTE_SWCLK_SET_STR (char []){ REMOTE_SOM, REMOTE_GEN_PACKET, REMOTE_SWCLK_SET, '%', 'u', REMOTE_EOM, 0 }
#define REMOTE_SWCLK_GET_STR (char []){ REMOTE_SOM, REMOTE_GEN_PACKET, REMOTE_SWCLK_GET, REMOTE_EOM, 0 }
